...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'registry' => 'registro',
        'state.status' => 'status',
        'state.registry' => 'registro',
        'state.name' => 'nome',
        'content' => 'conteúdo',
        'value' => 'valor',
        'acronym' => 'sigla',
        'taxpayer_registration' => 'cpf',
        'identity_registration' => 'rg',
        'driving_licence' => 'cnh',
        'company_id' => 'empresa',
        'participant_role_id' => 'função',
        'user.name' => 'nome do usuário',
        'user.email' => 'email do usuário',
        'user.password' => 'senha do usuário',
        'user.phone' => 'telefone do usuário',
        'user.document' => 'documento',
        'training_id' => 'treinamento',
        'date_event' => 'data',
        'event_start' => 'periodo',
        'event_end' => 'periodo',
        'training_room_id' => 'sala',
        'time01_id' => '1º horário',
        'time02_id' => '2º horário',
        'quantity_people' => 'quantidade',
        'start_event' => 'início',
        'workload_id' => 'carga horária',
        'schedule_prevat_id' => 'evento',
        'state.schedule_prevat_id' => 'Treinamento',
        'state_date_event' => 'data',
        'state.training_local_id' => 'local',
        'state.training_room_id' => 'sala',
        'state.workload_id' => 'carga horária',
        'state.time01_id' => '1º horário',
        'state.time02_id' => '2º horário',
        'state.template_id' => 'template',
        'state.start_event' => 'início',
        'state.end_event' => 'fim',
        'state.date_event' => 'data',
        'state.training_id' => 'treinamento',
        'state.company_id' => 'empresa',
        'state.training_location_id' => 'local de treinamento',
        'state.vacancies' => 'vagas',
        'employer_number' => 'cnpj',
        'state.professional_id' => 'profissional',
        'state.professional_formation_id' => 'qualificação',
        'featured' => 'destaque',
        'time_type' => 'tipo de tempo',
        'vacancies' => 'vagas',
        'end_event' => 'fim',
        'training_participation_id' => 'treinamento do participante',
        'content_title' => 'título',
        'contract' => 'contrato',
        'Monday' => 'Segunda',
        'contract.name' => 'nome do contrato',
        'contract.contract' => 'contrato',
        'contract_id' => 'contrato da empresa',
        'state.contract_id' => 'contrato',
        'file_path' => 'arquivo',
        'category_id' => 'categoria',
        'contractor_id' => 'contratante',
        'action_plan' => 'plano de ação',
        'responsible_plan' => 'responsavel',
        'notifications' => 'realizado',
        'date_execution' => 'data de execução',
        'due_date' => 'data de vencimento',
        'payment_method_id' => 'tipo de pagamento',
        'order.payment_method_id' => 'tipo de pagamento',
        'order.due_date' => 'data de vencimento',
        'type' => 'tipo',
