...
@section('content')
    ...
    <div class="page-header d-sm-flex d-block">
        ...
        <div class="ms-auto">
            <div>
                ...
                <a href="{{route('client.movement.schedule-company')}}" class="btn bg-warning-transparent text-warning mx-2 btn-sm" data-bs-toggle="tooltip"
                ...
                <a href="{{route('client.movement.schedule-company.create')}}" class="btn bg-success-transparent text-success  mx-2 btn-sm" data-bs-toggle="tooltip"
    ...
    @livewire('client.schedule-company.view', ['reference' => $reference])
