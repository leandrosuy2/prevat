    ...
    <div class="page-header d-sm-flex d-block">
        ...
        <div class="ms-auto">
            <div>
                ...
                {{--                @can('add_training')--}}
                <a href="{{route('financial.service-order.create')}}" class="btn bg-warning-transparent text-warning btn-sm" data-bs-toggle="tooltip"
...
{{--                                @endcan--}}
    ...
    @livewire('financial.service-order.table')
