...
@section('content')
    ...
    <div class="page-header d-sm-flex d-block">
        ...
        <div class="ms-auto">
            <div>
                ...
                <a href="{{route('movement.schedule-prevat')}}" class="btn bg-warning-transparent text-warning btn-sm" data-bs-toggle="tooltip"
    ...
    @livewire('movement.schedule-prevat.form', ['id' => $id])
