...
@section('content')
    ...
    <div class="page-header d-sm-flex d-block">
        <ol class="breadcrumb mb-sm-0 mb-3">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('movement.schedule-company')}}">Movimentações</a></li>
    ...
    @livewire('movement.participant-training.professional.table' , ['id' => $id])
