...
@section('content')
    <div class="page-header d-sm-flex d-block">
        <ol class="breadcrumb mb-sm-0 mb-3">
            ...
            <li class="breadcrumb-item " aria-current="page"><a href="{{route('movement.participant-training.certificates', $id)}}"> Certificados </a></li>
        ...
        <div class="ms-auto">
            <div>
                ...
                {{--                @endcan--}}
                <a href="{{route('movement.participant-training.certificates', $id)}}" class="btn bg-danger-transparent text-danger mx-2 btn-sm" data-bs-toggle="tooltip"
    ...
    @livewire('movement.participant-training.certificates.printer' , ['id' => $id])
