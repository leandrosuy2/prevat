...
@section('content')
    ...
    <div class="page-header d-sm-flex d-block">
        <ol class="breadcrumb mb-sm-0 mb-3">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('contractor.schedule-company')}}">Agenda Empresa</a></li>
        ...
        <div class="ms-auto">
            <div>
                ...
                <a href="{{route('contractor.schedule-company')}}" class="btn bg-warning-transparent text-warning btn-sm" data-bs-toggle="tooltip"
    ...
    @livewire('contractor.schedule-company.participants.table' , ['reference' => $reference])
