        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title fs-14">{{$time ? 'Edição de ' : 'Cadastro de novo '}} Horário</h3>
                </div>
                <div class="card-body">
                    ...
                    <form wire:submit="save" class="form-horizontal">
                        <div class="row">
                            <div class="col-md-12 col-xl-5">
                                <div class="form-group">
                                    <label for="Nome do Usuário" class="form-label">Horário</label>
                        ...
                        <button type="submit" class="btn btn-primary"> {{$time ? 'Atualizar' : 'Cadastrar'}}</button>
                    </form>
