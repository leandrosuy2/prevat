        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title fs-14">{{$contractor ? 'Edição de ' : 'Cadastro de novo '}} Contratante</h3>
                </div>
                <div class="card-body">
                    <h5 class="card-sub-title text-info">
                        Insira abaixo os dados da novo contrato.
                    </h5>
                    ...
                    <form wire:submit="save" class="form-horizontal">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input  wire:model="state.contract" class="form-control">
                                    @error('contract')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group"  x-data="{ show: true }">
                                            <input :type="show ? 'password' : 'text'"  wire:model.live="state.user.password" class="form-control">
                        ...
                        <button type="submit" class="btn btn-primary"> {{$contractor ? 'Atualizar' : 'Cadastrar'}}</button>
                    </form>
