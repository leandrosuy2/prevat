        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title fs-14">{{$workload ? 'Edição de ' : 'Cadastro de nova '}} Carga Horária</h3>
                </div>
                <div class="card-body">
                    ...
                    <form wire:submit="save" class="form-horizontal">
                        ...
                        <button type="submit" class="btn btn-primary"> {{$workload ? 'Atualizar' : 'Cadastrar'}}</button>
                    </form>
