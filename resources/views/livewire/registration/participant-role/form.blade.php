        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title fs-14">{{$participantRole ? 'Edição de ' : 'Cadastro de nova '}} Função</h3>
                </div>
                <div class="card-body">
                    ...
                    <form wire:submit="save" class="form-horizontal">
                        <div class="row">
                            <div class="col-md-12 col-xl-5">
                                <div class="form-group">
                                    <label for="Nome do Usuário" class="form-label">Função</label>
                        ...
                        <button type="submit" class="btn btn-primary"> {{$participantRole ? 'Atualizar' : 'Cadastrar'}}</button>
                    </form>
