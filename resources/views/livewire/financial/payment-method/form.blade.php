        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title fs-14">{{$paymentMethod ? 'Edição de ' : 'Cadastro de novo '}} tipo de pagamento </h3>
                </div>
                <div class="card-body">
                    ...
                    <form wire:submit="save" class="form-horizontal">
                        ...
                        <button type="submit" class="btn btn-primary"> {{$paymentMethod ? 'Atualizar' : 'Cadastrar'}}</button>
                    </form>
                </div>
