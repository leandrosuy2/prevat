    ...
    <div class="offcanvas-header">
        <div class="col-md-12 col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                        @livewire('financial.service-order.releases.filter', ['company_id' => $company_id])
                                ...
                                @foreach($response->releases as $itemRelease)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <button wire:click.prevent="addRelease({{$itemRelease['id']}})" class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top"
                                               title="Adicionar">
