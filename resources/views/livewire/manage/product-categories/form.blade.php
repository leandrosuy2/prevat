        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title fs-14">{{$category ? 'Edição de ' : 'Cadastro de nova '}} Categoria de produto</h3>
                </div>
                <div class="card-body">
                    ...
                    <form wire:submit="save" class="form-horizontal">
                        ...
                        <button type="submit" class="btn btn-primary"> {{$category ? 'Atualizar' : 'Cadastrar'}}</button>
                    </form>
