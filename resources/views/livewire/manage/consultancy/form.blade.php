        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title fs-14">{{$consultancy ? 'Edição de ' : 'Cadastro de nova '}}  Consultoria</h3>
                </div>
                <div class="card-body">
                    <p class="card-sub-title text-muted">
                        Insira abaixo as informações da Consultoria
                    </p>
                    ...
                    <form wire:submit="save" class="form-horizontal">
                        ...
                        <button type="submit" class="btn btn-primary"> {{$consultancy ? 'Atualizar' : 'Cadastrar'}}</button>
                    </form>
