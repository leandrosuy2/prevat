        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title fs-14">{{$evidence ? 'Edição de ' : 'Cadastro de nova '}} Evidência</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form wire:submit="save" class="form-horizontal mt-5">
                        <div class="row">
                            <div class="col-md-12 col-xl-2">
                                <div class="form-group">
                                    <x-datepicker label="Data" wire:model="state.date" class="form-control"> </x-datepicker>
                                    @error('date')
                        ...
                        <div class="py-2">
                            <button type="submit" class="btn btn-primary"> {{$evidence ? 'Atualizar' : 'Cadastrar'}}</button>
                        </div>
