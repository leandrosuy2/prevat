                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-6">
                                    <div class="form-group">
                                        <label for="Nome do Usuário" class="form-label">Nome do Contrato</label>
                                        <input type="text" wire:model="state.contract.name" class="form-control">
                                        @error('contract.name')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12 col-xl-6">
                                    <div class="form-group">
                                        <label for="E-mail" class="form-label">Numero do Contrato</label>
                                        <input  wire:model="state.contract.contract" class="form-control">
