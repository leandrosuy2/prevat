            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center m-0">
                    ...
                    @if(auth()->user()->company->type == 'client')
                        <a href=" {{ route('client.registration.participant.create') }}" class="fw-semibold btn btn-sm btn-primary"><i class="fe fe-plus-circle"></i> Novo Participante </a>
                   @endif
                </div>
                ...
                <div class="card-body" style="z-index: 5">
                    ...
                    @livewire('client.participants.filter')
                                ...
                                @foreach($response->participants as $itemParticipant)
                                    <tr>
                                        <td>
                                            <div class="d-flex">
                                                <div class="flex-1">
                                                    ...
                                                    <span class="text-muted fw-semibold fs-12 text-nowrap"> {{$itemParticipant['role']['name']}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="fw-semibold text-dark">
                                            ...
                                            <span class="text-muted fw-semibold fs-12">Telefone : {{ $itemParticipant['phone'] }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="{{ route('client.registration.participant.historic', $itemParticipant['id']) }}" class="btn btn-sm btn-icon btn-cyan">
                                                <i class="fe fe-list"></i>
                                            </a>
                                            <a href="{{ route('client.registration.participant.edit', $itemParticipant['id']) }}" class="btn btn-sm btn-icon btn-warning">
...
<script type="text/javascript">
    function modalDelete(client) {
        ...
        $('#confirmDelete').text('confirmDeleteParticipantClient');
