        ...
        <div class="col-12 col-sm-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href=" {{ route('client.movement.schedule-company.create') }}" class="fw-semibold btn btn-sm btn-primary"> <i class="fe fe-plus-circle"></i> Nova Agenda </a>
                </div>
                ...
                <div class="card-body" style="z-index: 5">
                    ...
                    @livewire('client.schedule-company.filter')
                    ...
                    <div class="e-table">
                        <div class="table-responsive table-lg">
                            <table class="table table-bordered text-dark">
                                ...
                                <tr>
                                    <th class="fw-bold fs-11 w-10 text-center">Referencia</th>
                                    <th class="fw-bold fs-11">Treinamento</th>
                                    <th class="fw-bold fs-11">Horarios</th>
                                    <th class="fw-bold fs-11 text-center">Sala</th>
                                ...
                                @foreach($response->scheduleCompanies as $itemSchedule)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="flex-1">
                                                    ...
                                                    <span class="text-muted fw-semibold fs-11">{{ $itemSchedule['schedule']['location']['name'] }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="fw-semibold text-dark fs-10 text-nowrap">
                                            @if($itemSchedule['schedule']['second_time'])
                                                {{ $itemSchedule['schedule']['first_time']['name'] ?? 'Sem Cadastro' }}<br>
                                                {{ $itemSchedule['schedule']['second_time']['name'] ?? ' ' }}<br>
                                            @else
                                                {{ $itemSchedule['schedule']['first_time']['name'] ?? 'Sem Cadastro' }}
                                            @endif
                                        </td>
                                        <td class="fw-semibold text-dark text-center text-nowrap fs-11"> {{ $itemSchedule['schedule']['room']['name'] }}</td>
                                        ...
                                        <td class="text-nowrap">
                                            ...
                                            <a href="{{ route('client.movement.schedule-company.view', $itemSchedule['reference']) }}" class="btn btn-sm btn-icon btn-cyan" data-bs-toggle="tooltip" data-bs-placement="top"
                                               title="Vizualizar">
                                                <i class="fe fe-eye"></i>
                                            </a>

                                            <a href="{{ route('client.movement.schedule-company.participants', $itemSchedule['id']) }}" class="btn btn-sm btn-icon btn-info {{$itemSchedule['schedule']['status'] == 'Concluído' ? 'disabled' : ''}}" data-bs-toggle="tooltip" data-bs-placement="top"
                                               title="Participantes">
                                                <i class="fe fe-users"></i>
                                            </a>

                                            <a href="{{ route('client.movement.schedule-company.edit', $itemSchedule['id']) }}" class="btn btn-sm btn-icon btn-warning {{$itemSchedule['schedule']['status'] == 'Concluído' ? 'disabled' : ''}}" data-bs-toggle="tooltip" data-bs-placement="top"
                                               title="Editar">
