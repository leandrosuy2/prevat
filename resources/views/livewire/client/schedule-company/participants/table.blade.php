            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="">
                        ...
                        <button class="btn btn-sm btn-secondary" type="button" wire:click="openSlide('client.schedule-company.participants.card', {'schedule_company_id' : {{$scheduleCompany['id']}}, 'id' : {{$scheduleCompany['company']['id']}}, 'edit' : 'true' })"><i class="fa fa-users"></i> Adicionar Participantes</button>
                        <button class="btn btn-sm btn-warning" type="button" wire:click.prevent="openModal('client.schedule-company.participant.form', {'schedule_company_id' : {{$scheduleCompany['id']}}, 'id' : {{$scheduleCompany['company']['id']}} } )"><i class="fa fa-user"></i> Cadastrar Participante</button>
                    </div>
                ...
                <div class="card-body" style="z-index: 5">
                    ...
                    @livewire('client.schedule-company.participants.filter')
...
<script type="text/javascript">
    function modalDelete(client) {
        ...
        $('#confirmDelete').text('confirmDeleteScheduleParticipanteClient');
